...
io_reg_t iopl_port_list[] = {
	...
	/*
	 * No PCI configuration ports (#597): the kernel serialises their
	 * two-step access under pci_cfg_port_lock, and a task in this list
	 * would drive it outside the lock.  Nothing in the tree asked for them.
	 */
