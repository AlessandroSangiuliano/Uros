...
/* The median, before any exact source was adopted. */
uint64_t lapic_timer_measured_hz(void);

/* What each exact source states after the divisor, how far it is from the
 * measurement, and which was adopted -- by the rule time/exact.c states for
 * the TSC too (#508, #594). */
struct exact_choice;
