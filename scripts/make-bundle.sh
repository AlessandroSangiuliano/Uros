...
HAL_PCI_SCAN_MODULE="$BUILD_DIR/src/servers/hal_server/modules/pci_scan.so"
AHCI_MODULE="$BUILD_DIR/src/servers/block_device_server/modules/ahci.so"
VIRTIO_BLK_MODULE="$BUILD_DIR/src/servers/block_device_server/modules/virtio_blk.so"
GPU_SERVER="$SBIN/gpu_server"
GPU_VGA_MODULE="$BUILD_DIR/src/servers/gpu_server/modules/vga.so"
CHAR_SERVER="$SBIN/char_server"
CHAR_PS2_MODULE="$BUILD_DIR/src/servers/char_server/modules/ps2.so"
CHAR_UART_MODULE="$BUILD_DIR/src/servers/char_server/modules/uart.so"
CHAR_PS2_MOUSE_MODULE="$BUILD_DIR/src/servers/char_server/modules/ps2_mouse.so"
CHAR_CONSOLE_MODULE="$BUILD_DIR/src/servers/char_server/modules/console.so"
